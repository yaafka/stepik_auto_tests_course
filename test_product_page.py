...
def test_guest_can_add_product_to_basket(link):
    ...
    name_of_book_1 = productpage.find_xpath(
        '//div[@class = "col-sm-6 product_main"]/h1').text
    sale_of_book_1 = productpage.find_xpath(
        '//div[@class = "col-sm-6 product_main"]/p[@class = "price_color"]').text
    productpage.click_add_button()
    productpage.solve_quiz_and_get_code()
    name_of_book_2 = productpage.find_xpath(
        '//div[@class = "col-sm-6 product_main"]/h1').text
    sale_of_book_2 = productpage.find_xpath(
        '//div[@class = "alertinner "]/p/strong').text
